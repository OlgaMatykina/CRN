...
class TestRVTLSSFPN(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.rvt_lss_fpn = RVTLSSFPN(**self.backbone_img_conf).cuda()
    ...
    def test_forward(self):
        ...
        nusc_dataset = NuscDatasetRadarDet(self.ida_aug_conf,
                                self.bda_aug_conf,
                                rda_aug_conf,
                                CLASSES,
                                '../HPR1/nuscenes',
        ...
        preds = self.rvt_lss_fpn.forward(sweep_imgs, mats, ptss_context, ptss_occupancy, \
